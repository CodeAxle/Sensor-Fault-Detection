...
class ModelEvaluation:
    ...
    def initiate_model_evaluation(self)->ModelEvaluationArtifact:
        try:
            ...
            logging.info(f"target data type :{y_true.dtype}")
            logging.info(f"target data values :{y_true.unique()}")
            ...
            if not model_resolver.is_model_exists():
                model_evaluation_arifact = ModelEvaluationArtifact(
                ...
                logging.info(f"Model evaluation artifact:{model_evaluation_arifact}")
            ...
            if self.model_eval_config.change_threshold < trained_metric-latest_metric:
                # 0.02 < 0.03 (Change accepted)
                is_model_accepted=True
            else:
            ...
            model_eval_report = model_evaluation_arifact.__dict__()
